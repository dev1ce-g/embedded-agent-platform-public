...
def main(argv: list[str] | None = None) -> int:
    ...
    commands = [f"device {args.Device}", f"si {args.Interface}", f"speed {args.Speed}", "connect", f"loadbin {binary}, {args.Address}", f"verifybin {binary}, {args.Address}"]
    if not args.NoRun:
        commands.extend(["r", "g"])
